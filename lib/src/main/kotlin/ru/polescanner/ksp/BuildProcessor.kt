        ...
        return builder
            ...
            .addFunction(
                FunSpec.builder("to$mapTo")
                    ...
                    .addStatement("return this.map{ it.to$mapTo() }")
                    .build()
            )
            .addFunction(
                FunSpec.builder("to$mapFrom")
                    ...
                    .returns(domainList)
                    .addStatement("return this.map{ it.to$mapFrom() }")
                    .build()
            )
            .addFunction(
                FunSpec.builder("to$mapTo")
                    ...
                    .addStatement("return this.map{ it.to$mapTo() }.toTypedArray()")
                    .build()
            )
            .addFunction(
                FunSpec.builder("to$mapFrom")
                    ...
                    .returns(domainArray)
                    .addStatement("return this.map{ it.to$mapFrom() }.toTypedArray()")
                    .build()
            )
